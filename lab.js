...
let wizard = new Wizard('Cade', 21, 'Fireball')
...
let apple = new Phone ('Apple', 'Iphone', 64, 'Red', 199.95)
let android = new Phone ('Android', 's10', 32, 'black', 189.95)
let google = new Phone ('Google', 'Pixel', 124, 'white', 200.00)
/* 
